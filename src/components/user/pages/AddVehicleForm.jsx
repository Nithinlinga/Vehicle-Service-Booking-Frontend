...
const carModels = {
  ...
  mazda: [{ value: '', label: 'Select Model' }, { value: 'cx-5', label: 'CX-5' }, { value: 'mazda3', label: 'Mazda3' }],
  ferrari: [{ value: '', label: 'Select Model' }, { value: '488', label: '488 GTB' }, { value: 'roma', label: 'Roma' }],
  lamborghini: [{ value: '', label: 'Select Model' }, { value: 'huracan', label: 'Huracán' }, { value: 'aventador', label: 'Aventador' }],
  jaguar: [{ value: '', label: 'Select Model' }, { value: 'xf', label: 'XF' }, { value: 'f-type', label: 'F-Type' }],
  landrover: [{ value: '', label: 'Select Model' }, { value: 'defender', label: 'Defender' }, { value: 'discovery', label: 'Discovery' }],
  rollsroyce: [{ value: '', label: 'Select Model' }, { value: 'phantom', label: 'Phantom' }, { value: 'ghost', label: 'Ghost' }],
  bentley: [{ value: '', label: 'Select Model' }, { value: 'continental', label: 'Continental GT' }, { value: 'flying-spur', label: 'Flying Spur' }],
  astonmartin: [{ value: '', label: 'Select Model' }, { value: 'db11', label: 'DB11' }, { value: 'vantage', label: 'Vantage' }],
  bugatti: [{ value: '', label: 'Select Model' }, { value: 'chiron', label: 'Chiron' }, { value: 'veyron', label: 'Veyron' }],
  citroen: [{ value: '', label: 'Select Model' }, { value: 'c3', label: 'C3' }, { value: 'c5', label: 'C5 Aircross' }],
  peugeot: [{ value: '', label: 'Select Model' }, { value: '208', label: '208' }, { value: '3008', label: '3008' }],
  renault: [{ value: '', label: 'Select Model' }, { value: 'kwid', label: 'Kwid' }, { value: 'duster', label: 'Duster' }],
  skoda: [{ value: '', label: 'Select Model' }, { value: 'octavia', label: 'Octavia' }, { value: 'kodiaq', label: 'Kodiaq' }],
  seat: [{ value: '', label: 'Select Model' }, { value: 'ibiza', label: 'Ibiza' }, { value: 'leon', label: 'Leon' }],
  mini: [{ value: '', label: 'Select Model' }, { value: 'cooper', label: 'Cooper' }, { value: 'clubman', label: 'Clubman' }],
  suzuki: [{ value: '', label: 'Select Model' }, { value: 'swift', label: 'Swift' }, { value: 'ciaz', label: 'Ciaz' }],
  mitsubishi: [{ value: '', label: 'Select Model' }, { value: 'outlander', label: 'Outlander' }, { value: 'pajero', label: 'Pajero' }],
  infiniti: [{ value: '', label: 'Select Model' }, { value: 'q50', label: 'Q50' }, { value: 'qx60', label: 'QX60' }],
  acura: [{ value: '', label: 'Select Model' }, { value: 'ilx', label: 'ILX' }, { value: 'mdx', label: 'MDX' }],
  alfa: [{ value: '', label: 'Select Model' }, { value: 'giulia', label: 'Giulia' }, { value: 'stelvio', label: 'Stelvio' }]
};
