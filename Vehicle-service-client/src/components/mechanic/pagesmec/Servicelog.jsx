        ...
        <table className="min-w-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm">
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
            {serviceLog.map(({ id, service, date, amount, customer, car, status }) => (
              <tr key={id} className="hover:bg-cyan-50 dark:hover:bg-gray-700 transition">
                <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{date}</td>
                <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{customer}</td>
                <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{service}</td>
                <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{car}</td>
